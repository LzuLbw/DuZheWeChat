...
<style scoped lang="scss" >
	.date-wrap{
		...
		.cur-date{font-size: 30upx;}
		.item-box{
			display: flex;color: #777;flex-wrap: wrap;font-size: 28upx;justify-content: flex-start;
			.item{
				width: calc(100% / 10); margin: 10upx auto;border-radius: 100upx;
			}
			.disabled{
				background: #efefef;color: #999;
			}
			.active{
				background: linear-gradient(90deg, #fff, red);color: #fff;
			}
		}
	}
</style>
