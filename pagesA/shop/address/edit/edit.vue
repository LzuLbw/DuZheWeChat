<template>
	<view class='my-add-path'>
		...
		<view class="del" v-if="editType=='edit'" @tap="del">
			<view class=".del-btn">
				<view class="del-icon"></view>删除收货地址
			</view>
		</view>
...
<script>
	...
	import mpvueCityPicker from '@/pagesA/components/mpvue-citypicker/mpvueCityPicker.vue'
	import {
		mapActions
	} from 'vuex'
	export default {
		...
		onNavigationBarButtonTap() {
			let data = {
				...
				"head": this.pathObj.name.substr(0, 1),
				"tel": this.pathObj.tel,
				"detailed": this.pathObj.detailed,
