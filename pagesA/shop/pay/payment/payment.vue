			...
			<view class="content">
				<view class="pay-list">
					<view class="row" @tap="paytype='alipay'">
							<view class="left">
								<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/shop/alipay.png"></image>
							</view>
							<view class="center">
								支付宝支付
							</view>
					...
					<view class="row" @tap="paytype='wxpay'">
							<view class="left">
								<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/shop/wxpay.png"></image>
							</view>
							<view class="center">
								微信支付
							</view>
					...
					<view class="row" @tap="paytype='pocketpay'">
							<view class="left">
								<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/shop/quan.png"></image>
							</view>
							<view class="center">
								我的钱包支付
							</view>
