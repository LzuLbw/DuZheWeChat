	...
	<view>
		...
		<view class="share" :class="shareClass" @touchmove.stop.prevent="discard" @tap="hideShare">
			...
			<view class="layer" @tap.stop="discard">
				...
				<view class="list">
					<view class="box">
						<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/wx.png" @tap="toShareWexin()"></image>
						<view class="title">
							微信好友
						</view>
					</view>
					<view class="box">
						<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/pyq.png" @tap="toShareWexinScene()"></image>
						<view class="title">
							朋友圈
						</view>
					</view>
					<view class="box">
						<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/wb.png" @tap="toShareWeibo()"></image>
						<view class="title">
							新浪微博
						</view>
					</view>
					<view class="box">
						<image src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/qq.png" @tap="toShareQQ()"></image>
						<view class="title">
							QQ
						</view>
					</view>
