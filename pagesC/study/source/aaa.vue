...
<script>
	import videoPlayer from '@/pagesC/components/videoPlayer.vue'
	import listLeft from '@/pagesC/components/listLeft.vue'
	import listRight from '@/pagesC/components/listRight.vue'
	var time = null
	export default {
		props:['list'],
		name:"videoList",
