...
<template>
	<view style="height: 100%;">
		...
		<!-- ************************** -->
		<!-- 封面 -->
		<view v-for="(item,index) in alist" :key="index" class="cover container" :class="{container0: background === 1, container1: background === 2}"
...
<script>
	import battery from '@/pagesC/components/battery.vue'
	import virtualList from '@/pagesC/components/virtualList.vue'
