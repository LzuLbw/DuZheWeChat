...
export function listUser_withdraw_cash_list(query) {
  return request({
    url: '/readerstation-member/user_withdraw_cash_list/list',
    method: 'get',
    params: query
  })
}
...
export function getUser_withdraw_cash_list(id) {
  return request({
    url: '/readerstation-member/user_withdraw_cash_list/' + id,
    method: 'get'
  })
}
...
export function addUser_withdraw_cash_list(data) {
  return request({
    url: '/readerstation-member/user_withdraw_cash_list',
    method: 'post',
    data: data
  })
}
