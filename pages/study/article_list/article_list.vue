		...
		<!-- 搜索栏 -->
			...
			<!-- 顶部按钮 -->
			 <view style="display: flex;">
				 <view>
				<image @click="gotosort" src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/icon/study_sort.png" style="width: 60upx;height: 60upx;margin-left: 30px;"></image>
				<view style="margin-left: 30px;">分类</view>
				</view>
				<view>
				<image @click="gotoshell" src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/icon/study_shell.png" style="width: 60upx;height: 60upx;margin-left: 50px;"></image>
				...
				<view>
				<image @click="gotocollection" src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/icon/collection.png" style="width: 60upx;height: 60upx;margin-left: 50px;"></image>
...
<script>
	...
	export default {
		...
		gotosort(){
			uni.navigateTo({
				url:'/pagesC/study/articlesort/articlesort'
			})
		},
		gotoshell(){
			uni.navigateTo({
				url:'/pagesC/study/articleshell/articleshell'
			})
		},
		gotonote(){
			uni.navigateTo({
				url:'/pagesC/study/note/note'
			})
		},
		gotocollection(){
			uni.navigateTo({
				url:'/pagesC/study/collection/collection'
			})
		},
		godetails(e){
			...
			var id=e.id;
			uni.navigateTo({
				url:'/pagesC/study/article_details/article_details?id='+id,
				success: (res) => {
					console.log("打开成功");
				}
			})
		...
		search(){
			...
			uni.navigateTo({
				url:"/pagesC/study/search/search?title="+title,
				success: (res) => {
					console.log("搜索成功");
