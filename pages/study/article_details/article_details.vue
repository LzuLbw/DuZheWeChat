<template>
	<view>
		<scroll-view scroll-y="true" class="content" v-for="(item,index) in alist" :key="index">
...
<script>
	...
	export default {
		...
		onLoad:function(e){
			console.log(getApp().globalData.uid+'当前登录');
			console.log(getApp().globalData.name+'用户名');
			console.log(e);
			this.id=e.id;
			uni.request({
