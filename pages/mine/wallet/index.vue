	...
	export default {
		...
		data() {
			return {
				...
				options: {
					layer: '/static/hm-balance-card/images/img_25821_0_0.png',
					info: '余额',
					zhanghaoguanli: '/static/hm-balance-card/images/img_25821_0_2.png',
					bd: '12929.05',
					...
					cvv: 'CVV',
					num: '235',
					largeIcon: '/static/hm-balance-card/images/img_25821_0_1.png'
				}
			};
		},
		onLoad() {
