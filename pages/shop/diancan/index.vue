	...
	<view>
		...
		<view class="top-view">
			...
			<view class="top-view-flex">
				<image src="/static/image/shop/fenxiang.svg" mode="widthFix" class="top-search"></image>
				<image src="/static/image/shop/dingdan.svg" mode="widthFix" @click="my_order()"></image>
			</view>
		</view>
			...
			<view class="order-bottom" @click="pop_Shopping()" :style="{'padding-bottom': Modelmes ? '68rpx' : ''}">
				<view class="Shopping" style="width: 115rpx;">
					<view class="Shopping-left">
						<image src="/static/image/shop/gouwuche.png" mode="widthFix"></image>
					</view>
...
<script>
	...
	// 引入购物车子组件
	import Cart from '@/components/shop/diancan/shopping-cart.vue'
	// 引入单个商品弹出
	import Details from '@/components/shop/diancan/goods-details.vue'
	// 订单编号
	import {
		Code
	} from '@/components/shop/diancan/config/order.js'
	// 计算当天的销售额
	// import {
	// 	analysis
				...
				goods: [{
						...
						good_query: [{
							...
							image: [{
								status: "success",
								uid: 1633614408430,
								url: "/static/image/shop/zhenzhunaicha.png",
							}],
							monthlysale: 7,
							name: "珍珠奶茶",
							onsale: true,
