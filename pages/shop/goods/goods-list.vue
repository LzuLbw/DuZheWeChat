		...
		<view class="goods-list">
			<view class="product-list">
				<view class="product" v-for="(goods) in goodsList" :key="goods.goods_id" @tap="toGoods(goods)">
					<image class="product-image" :src="goods.img"></image>
...
<script>
	export default {
		data() {
			return {
				goodsList:[
					{ goods_id: 0, img: '/static/image/tb_forest.jpg', name: '三体', price: '￥100', slogan:'1235人付款' },
					{ goods_id: 1, img: '/static/image/the_wandering_earth.jpg', name: '流浪地球', price: '￥60', slogan:'1235人付款' },
					{ goods_id: 2, img: '/static/image/the_earth.jpg', name: '地球', price: '￥90', slogan:'1235人付款' },
					{ goods_id: 3, img: '/static/image/sand_dunes.jpg', name: '沙丘', price: '￥60', slogan:'1235人付款' },
				],
				loadingText:"正在加载...",
				headerTop:"0px",
