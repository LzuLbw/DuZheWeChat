<template>
	<view class="page_content">
		<image class="logo" src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/head.png"></image>
			...
			<template v-for="(vip, i) in vips">
				<swiper-item :key="i">
					<view :class="['swiper-item',bigIdx === i ? 'big' : 'small']" :style="{background:vip.bg,'box-shadow':vip.shadow}">
						<image class="img" src="https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_vip.png"></image>
	...
	export default {
		data() {
			return {
				...
				taskList:[],	
				tasks: [{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_signin.png',
						name: '连续7天签到',
						desc: '积分：'
					},
					{
					...
					{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_friend.png',
						name: '邀请好友参加',
						desc: '积分：'
					}
				],
				welfare: [{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_evaluate.png',
						name: '我的钱包',
						url:  '/pages/mine/wallet/index'
					},
					{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_gift.png',
						name: '积分兑换',
						url:  '/pages/mine/member/exchange/index'
					},
					{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_score.png',
						name: '积分排行',
						url:  '/pages/mine/member/integral/ranklist'
					},
					{
						icon: 'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/icon_other.png',
						name: '其他功能',
