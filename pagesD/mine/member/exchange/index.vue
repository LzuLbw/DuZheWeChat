	...
	export default {
		data() {
			return {
				bgyx: false,
				total: '',
				lblist:['https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/head.png','https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/head.png'],
				banner:'https://reader-station.oss-cn-hangzhou.aliyuncs.com/images/mine/head.png',
				prizeList:[]
			}
		},
		// computed: {
